...
#signal
signalFileName = '/eos/cms/store/user/nlu/Hmm/categorization/Oct03_v1/merged/WH.root'
signalFile = root.TFile(signalFileName)
signalTree = signalFile.Get('cattree')
#signalNevents = signalFile.Get('NEvents')

#bkg
bkgFileName = '/eos/cms/store/user/nlu/Hmm/categorization/Oct03_v1/merged/DY.root'
...
variables = ['MET_phi','MET_pt','Higgs_pt','Higgs_eta','dEtamm','dPhimm','extralep_eta','extralep_pt','extralep_mvaFall17Iso','dRlepHiggs'] 
...
#                             'cattree', columns=variables+id_variables)
