...
// Thu Aug 30 15:01:41 2018 by ROOT version 6.10/09
// from TTree Events/Events
// found on file: /eos/cms/store/user/nlu/Hmm/nanoAOD/sync/5AC9148F-9842-E811-892B-3417EBE535DA.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         Electron_mvaFall17Iso[6];   //[nElectron]
   Float_t         Electron_mvaFall17noIso[6];   //[nElectron]
   ...
   Bool_t          Electron_mvaFall17Iso_WP80[6];   //[nElectron]
   Bool_t          Electron_mvaFall17Iso_WP90[6];   //[nElectron]
   Bool_t          Electron_mvaFall17Iso_WPL[6];   //[nElectron]
   Bool_t          Electron_mvaFall17noIso_WP80[6];   //[nElectron]
   Bool_t          Electron_mvaFall17noIso_WP90[6];   //[nElectron]
   Bool_t          Electron_mvaFall17noIso_WPL[6];   //[nElectron]
   UInt_t          nFatJet;
   ...
   UInt_t          nGenPart;
   Float_t         GenPart_eta[117];   //[nGenPart]
   Float_t         GenPart_mass[117];   //[nGenPart]
   Float_t         GenPart_phi[117];   //[nGenPart]
   Float_t         GenPart_pt[117];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[117];   //[nGenPart]
   Int_t           GenPart_pdgId[117];   //[nGenPart]
   Int_t           GenPart_status[117];   //[nGenPart]
   Int_t           GenPart_statusFlags[117];   //[nGenPart]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/cms/store/user/nlu/Hmm/nanoAOD/sync/5AC9148F-9842-E811-892B-3417EBE535DA.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/cms/store/user/nlu/Hmm/nanoAOD/sync/5AC9148F-9842-E811-892B-3417EBE535DA.root");
      }
